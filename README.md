...
from additional physics or information in the representation. This package
does not claim quantum-state compression, unique measurement, lower hardware
error, or universal compiler superiority.
